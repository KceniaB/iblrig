...
if _api.USED_API == _api.QT_API_PYQT5:
	...
	if platform.system() == 'Darwin':
		from iblpybpod.pyforms_gui.controls.control_player.VideoQt5GLWidget import VideoQt5GLWidget as VideoGLWidget
	else:
		from iblpybpod.pyforms_gui.controls.control_player.VideoGLWidget 	 import VideoGLWidget
