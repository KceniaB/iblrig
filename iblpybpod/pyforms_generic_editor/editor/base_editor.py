...
from iblpybpod.pyforms.controls import ControlMdiArea
from iblpybpod.pyforms.controls import ControlDockWidget

import iblpybpod.pyforms_generic_editor as pyforms_generic_editor
from iblpybpod.pyforms_generic_editor.plugins import loader as plugin_loader
from iblpybpod.pyforms_generic_editor.editor.generic_file_editor import GenericFileEditor
...
class BaseEditor(BaseWidget):
	def __init__(self):
		...
		global conf
		conf += "iblpybpod.pyforms_generic_editor.resources"
