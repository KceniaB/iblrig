...
conf += "iblpybpod.pybpodgui_plugin_timeline.settings"
conf += "iblpybpod.pybpodgui_plugin_timeline.resources"
...
from iblpybpod.pybpodgui_plugin_timeline.trials_plot_window import TrialsPlotWindow as TrialsPlot
