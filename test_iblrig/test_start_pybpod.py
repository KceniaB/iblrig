...
if __name__ == "__main__":
    ...
    if args.test:
        for name in os.listdir(path_helper.get_iblrig_params_path()):  # delete the contents of the ibl_params dir (pybpod dir)
        ...
        shutil.copytree(
            path_helper.get_iblrig_path() / "pybpod_fixtures",
            path_helper.get_iblrig_params_path(),
            dirs_exist_ok=True)
